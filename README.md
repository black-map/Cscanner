# CScanner v1.5 - Advanced Network Scanner in C

A high-performance, modular network scanner written in C for Linux. Version 1.5 with enhanced features.
...
./cscanner -t target.com --test-mode
```
...
Exhaustive testing mode with full port coverage:
...
- Validates scanner accuracy
- Logs anomalies to cscanner_test.log
